...
import back from '../../assets/programs/back.JPG'
      ...
      <div className="hints1 flex items-center  justify-center  w-full ">
        <div className="container w-[90%] flex  items-center justify-center p-[50px]">
          <div className="head-img-container uppercase  flex max-[1168px]:flex-col-reverse  justify-between items-center w-[90%]   py-0">
            ...
            <img src={back} alt="" className='w-[500px] rounded-[40px] ' />
            <h1 
              ...
              >
                You are in the right place to become stronger and have greater muscle mass and flexibility in your body by combining more than one sport professionally.
              </h1> 
          </div>
        </div>
      </div>

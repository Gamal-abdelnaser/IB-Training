  ...
  return (
    <>
      <div className="w-full h-full bg-[#161C24] flex flex-col items-center justify-center">
        <div
          className={`${selectedTraining?.custombg} bigContainer relative mt-[50px] pt-[50px] w-full flex flex-row bg-[#161C24] justify-center selection:text-customSelection`}
        >
...
function Content({ selectedTraining }) {
  return (
    <div
      className={`content ${selectedTraining?.id === 1 && "max-lg:pb-[250px] pt-[100px]"} flex items-center justify-between w-full flex-row max-lg:flex-col-reverse z-10`}
    >
...
function IsCalistanics({ selectedTraining }) {
  return selectedTraining?.name === "IB Calistanics" ? (
